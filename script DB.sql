...
create OR REPLACE TRIGGER trigger_modified_at_estudiantes
  BEFORE UPDATE ON estudiantes
  	FOR EACH ROW
  		EXECUTE PROCEDURE function_modified_at_estudiantes();
...
create OR REPLACE TRIGGER trigger_modified_at_profesores
...
CREATE OR REPLACE TRIGGER trigger_modified_at_asignaturas
...
CREATE OR REPLACE TRIGGER trigger_modified_at_clases
